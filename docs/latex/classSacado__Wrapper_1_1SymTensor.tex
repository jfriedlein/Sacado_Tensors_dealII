...
162 
163             \textcolor{comment}{// Correct the off-diagonal terms by the factor of 0.5}
164              \textcolor{keywordflow}{if}(k!=l)\textcolor{comment}{/*Compare to Voigt notation since only SymmetricTensor instead of Tensor*/}
165                 Tangent[k][l] *= 0.5; \textcolor{comment}{// ToDo: check whether the 0.5* is necessary here too}
166         \}
167     \}
\end{DoxyCode}
...
\begin{DoxyCode}
180     \{
181         SymmetricTensor<2,dim> tmp;
182         (*this).get\_values(tmp);
183         \textcolor{keywordflow}{return} tmp;
184     \}
\end{DoxyCode}
...
\begin{DoxyCode}
172     \{
173         \textcolor{keywordflow}{for} ( \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} i=0; i<dim; ++i)
174             \textcolor{keywordflow}{for} ( \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} j=0; j<dim; ++j )
175                 tensor\_double[i][j] = ((*\textcolor{keyword}{this})[i][j]).val();
176     \}
\end{DoxyCode}
