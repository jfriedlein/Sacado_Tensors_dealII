...
\}
\end{DoxyCode}
 \hypertarget{index_Ex8}{}\section{8. Example\+: First and second derivatives}\label{index_Ex8}
...
\}
\end{DoxyCode}
 \hypertarget{index_Ex9}{}\section{9. Example\+: First and second derivatives}\label{index_Ex9}
...
eps\_fad.\hyperlink{classSacado__Wrapper_1_1SymTensor2_a54495897cfdd887d0081015571a28107}{init\_set\_dofs}(eps);
std::cout << \textcolor{stringliteral}{"eps\_fad="} << eps\_fad << std::endl;
\end{DoxyCode}
 Compute eps² = eps\+\_\+ij $\ast$ eps\+\_\+jk in index notation 
\begin{DoxyCode}
...
\end{DoxyCode}
 Compute the strain energy density 
\begin{DoxyCode}
\textcolor{comment}{//   Sacado\_Wrapper::SW\_double2<dim> energy;}
     Sacado::Fad::DFad<DFadType> energy;
     energy = lambda/2. * trace(eps\_fad)*trace(eps\_fad) + mu * trace(eps\_fad\_squared);
\end{DoxyCode}
...
std::cout << \textcolor{stringliteral}{"analy. sigma="} << sigma << std::endl;
\end{DoxyCode}
 Sacado-\/\+Tangent as \{$^\wedge$2 \}\{ \{\}$^\wedge$2\} 
\begin{DoxyCode}
SymmetricTensor<4,dim> C\_Sac;
...
\}
\end{DoxyCode}
 \hypertarget{index_Ex10}{}\section{10. Example\+: First and second derivatives}\label{index_Ex10}
...
\end{DoxyCode}
 The energy is outputted to give some insight into the storage of the values and derivatives. ~\newline
energy=399 \mbox{[} 17.\+5 32 40 21.\+5 48 25.\+5 150 \mbox{]} \mbox{[} 17.\+5 \mbox{[} 5 0 0 1 0 1 25 \mbox{]} 32 \mbox{[} 0 8 0 0 0 0 0 \mbox{]} 40 \mbox{[} 0 0 8 0 0 0 0 \mbox{]} 21.\+5 \mbox{[} 1 0 0 5 0 1 25 \mbox{]} 48 \mbox{[} 0 0 0 0 8 0 0 \mbox{]} 25.\+5 \mbox{[} 1 0 0 1 0 5 25 \mbox{]} 150 \mbox{[} 25 0 0 25 0 25 0 \mbox{]} \mbox{]}
