...
add the example 9 (factor 0.\+5) to the background group\end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000003}{Todo}]Check if factor 0.\+5 is also necessary for d\+\_\+sigma / d\+\_\+phi\end{DoxyRefDesc}
...
\hyperlink{Sacado-auxiliary__functions_8h_a868b94676739e612d9c95940e70892a9}{fad\_double} kappa (kappa\_param);
\end{DoxyCode}
...
\item[\hyperlink{todo__todo000008}{Todo}]try to merge the fad\+\_\+double data type with this templated data type \end{DoxyRefDesc}
...
\{
   ...
   (eps\_fad[i][j]).val() = \hyperlink{Sacado-auxiliary__functions_8h_a868b94676739e612d9c95940e70892a9}{fad\_double}(nbr\_dofs, x, eps[i][j]); \textcolor{comment}{// set up the "outer" derivatives}
\}

phi\_fad.diff( 6, nbr\_dofs );
phi\_fad.val() = \hyperlink{Sacado-auxiliary__functions_8h_a868b94676739e612d9c95940e70892a9}{fad\_double}(nbr\_dofs, 6, phi); \textcolor{comment}{// set up the "outer" derivatives}
...
\end{DoxyCode}
 \begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000009}{Todo}]Add the link to the ac.\+nz site\end{DoxyRefDesc}
...
\end{DoxyCode}
 \begin{DoxyNote}{Note}
Here we template $<$dim,Number$>$ for a function \char`\"{}on the same level\char`\"{}. If you template a member function with $<$\+Number$>$ inside a class template $<$dim$>$, use ~\newline

\begin{DoxyCode}
\textcolor{keyword}{template}<\textcolor{keywordtype}{int} dim>
\textcolor{keyword}{template}<\textcolor{keyword}{typename} Number>
