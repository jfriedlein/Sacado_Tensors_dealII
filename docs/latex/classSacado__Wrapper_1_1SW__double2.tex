...
\begin{DoxyCode}
455     \{
456         Curvature = argument.dx(this->\hyperlink{classSacado__Wrapper_1_1SW__double2_ae7327540ad1fd725ea78ffc2268b423a}{start\_index}).dx(this->
...
\begin{DoxyCode}
465     \{
466         \textcolor{keywordflow}{for}(\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} x=0;x<eps.n\_dofs;++x)
467         \{
468             \textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} i=eps.std\_map\_indicies[x].first;
469             \textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} j=eps.std\_map\_indicies[x].second;
470 
471 \textcolor{comment}{//          if ( i!=j )}
472 \textcolor{comment}{//              Curvature[i][j] = 0.5 * argument[i][j].val().dx(start\_index);   // ToDo: check the factor
       0.5}
473 \textcolor{comment}{//          else}
474                 Curvature[i][j] = argument[i][j].val().dx(\hyperlink{classSacado__Wrapper_1_1SW__double2_ae7327540ad1fd725ea78ffc2268b423a}{start\_index});
475         \}
476     \}
\end{DoxyCode}
\index{Sacado\+\_\+\+Wrapper\+::\+S\+W\+\_\+double2@{Sacado\+\_\+\+Wrapper\+::\+S\+W\+\_\+double2}!get\+\_\+curvature@{get\+\_\+curvature}}
...
\begin{DoxyCode}
483     \{
484         \textcolor{keywordflow}{for}(\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} x=0;x<eps.n\_dofs;++x)
485         \{
486             \textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} i=eps.std\_map\_indicies[x].first;
487             \textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} j=eps.std\_map\_indicies[x].second;
488 
489             \textcolor{keywordflow}{if} ( i!=j )
490                 Curvature[i][j] = 0.5 * argument.dx(\hyperlink{classSacado__Wrapper_1_1SW__double2_ae7327540ad1fd725ea78ffc2268b423a}{start\_index}).dx(x);  \textcolor{comment}{// ToDo: check the
       factor 0.5}
491             \textcolor{keywordflow}{else}
492                 Curvature[i][j] = argument.dx(\hyperlink{classSacado__Wrapper_1_1SW__double2_ae7327540ad1fd725ea78ffc2268b423a}{start\_index}).dx(x);
493         \}
494     \}
\end{DoxyCode}
...
\begin{DoxyCode}
435     \{
436         Tangent = argument.dx(this->\hyperlink{classSacado__Wrapper_1_1SW__double2_ae7327540ad1fd725ea78ffc2268b423a}{start\_index}).val();
437     \}
\end{DoxyCode}
\index{Sacado\+\_\+\+Wrapper\+::\+S\+W\+\_\+double2@{Sacado\+\_\+\+Wrapper\+::\+S\+W\+\_\+double2}!get\+\_\+tangent@{get\+\_\+tangent}}
\index{get\+\_\+tangent@{get\+\_\+tangent}!Sacado\+\_\+\+Wrapper\+::\+S\+W\+\_\+double2@{Sacado\+\_\+\+Wrapper\+::\+S\+W\+\_\+double2}}
...
\begin{DoxyCode}
442     \{
443         \textcolor{keywordflow}{for}(\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} x=0;x<eps.n\_dofs;++x)
444         \{
445             \textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} i=eps.std\_map\_indicies[x].first;
446             \textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} j=eps.std\_map\_indicies[x].second;
447             \textcolor{comment}{// ToDo: find a better way to loop over the indices than using eps as input argument}
448             Tangent[i][j] = argument[i][j].dx(\hyperlink{classSacado__Wrapper_1_1SW__double2_ae7327540ad1fd725ea78ffc2268b423a}{start\_index}).val();
449         \}
450     \}
\end{DoxyCode}
...
\begin{DoxyCode}
427     \{
428         (*this).diff( \hyperlink{classSacado__Wrapper_1_1SW__double2_ae7327540ad1fd725ea78ffc2268b423a}{start\_index} , nbr\_total\_dofs );
429         (*this).val() = \hyperlink{Sacado__Wrapper_8h_a868b94676739e612d9c95940e70892a9}{fad\_double}(nbr\_total\_dofs, \hyperlink{classSacado__Wrapper_1_1SW__double2_ae7327540ad1fd725ea78ffc2268b423a}{start\_index}, double\_init);
430     \}
\end{DoxyCode}
...
\begin{DoxyCode}
405 \{ Sacado::Fad::DFad<DFadType>::operator =( double\_init ) ;\textcolor{keywordflow}{return} *\textcolor{keyword}{this};\}
\end{DoxyCode}
\index{Sacado\+\_\+\+Wrapper\+::\+S\+W\+\_\+double2@{Sacado\+\_\+\+Wrapper\+::\+S\+W\+\_\+double2}!operator=@{operator=}}
\index{operator=@{operator=}!Sacado\+\_\+\+Wrapper\+::\+S\+W\+\_\+double2@{Sacado\+\_\+\+Wrapper\+::\+S\+W\+\_\+double2}}
...
\begin{DoxyCode}
406 \{ Sacado::Fad::DFad<DFadType>::operator =( fad\_assignment ) ;\textcolor{keywordflow}{return} *\textcolor{keyword}{this};\}
\end{DoxyCode}
